...
<Header title="Loan Calculator" hideTitle={!!selectMode}>
	<ExportImport
		{selectMode}
		{selectedIds}
		onStartExportSelect={startExportSelect}
		onStartDeleteSelect={startDeleteSelect}
	...
	>
		...
		<div class="modal modal-sm" role="document" onclick={(e) => e.stopPropagation()}>
			...
			<p class="confirm-text">
				Are you sure you want to delete {selectedIds.size} project{selectedIds.size !== 1 ? 's' : ''}? This cannot be
				undone.
			</p>
			<div class="form-actions">
